SoundRecognizer = {
  ...
  init: function (config) {
    ...
    this.recordLevelBack = config.recordLevelBack;
    this.handleRecordError = config.handleRecordError;
    this.handleRecordSucess = config.handleRecordSucess;
  ...
  RealTimeSendTry: function (rec, isClose) {
    ...
    var chunk = Recorder.SampleData(rec.buffers, rec.srcSampleRate, this.SampleRate, this.realTimeSendTryChunk, {
  ...
  initRecorder: function () {
    ...
    var rec = Recorder({
      ...
      onProcess: function (buffers, level, time, sampleRate) {
        if (that.recordLevelBack) {
          that.recordLevelBack(level);
        }
    ...
    rec.open(
      ...
      (errMsg, isUserNotAllow) => {
        ...
        console.info('============isUserNotAllow==============', isUserNotAllow);
        that.handleRecordError();
      }
    );
    this.rec = rec;
  },
