...
export type PopupProps = {
  ...
  offset?:
    ...
    | Partial<{ [anchor in maplibregl.Anchor]: maplibregl.PointLike }>;
...
function Popup(props: PopupProps) {
  ...
  const popup: maplibregl.Popup = useMemo(() => {
    const options = { ...props };
    // @ts-ignore
    const pp = new maplibregl.Popup(options).setLngLat([props.longitude, props.latitude]);
    pp.once('open', (e) => {
