...
import PagContext, { defaultData, Pagination } from './providers/pagination-provider';
...
const Pagination = (props: Partial<Pagination>) => {
  ...
  const [pageSize, setPageSize] = React.useState(allProps.pageSize > 0 ? allProps.pageSize : allProps.defaultPageSize);
